...
Elm.Main.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "AddMessage": return {ctor: "_Tuple2",_0: _U.update(model,{messages: A2($List._op["::"],_p1._0,model.messages)}),_1: $Effects.none};
         case "UpdateMessage": return {ctor: "_Tuple2",_0: _U.update(model,{newMessage: _p1._0}),_1: $Effects.none};
         default: return {ctor: "_Tuple2",_0: _U.update(model,{newMessage: ""}),_1: $Effects.task(socketMessage(action))};}
   });
   ...
   var addMessage = Elm.Native.Port.make(_elm).outboundSignal("addMessage",
   function (v) {
